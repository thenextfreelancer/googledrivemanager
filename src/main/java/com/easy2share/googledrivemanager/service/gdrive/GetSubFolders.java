...
public class GetSubFolders
{
   ...
   public static String getUploadLocationIdByName(final String driveFolderName) throws IOException
   {
      List<File> googleRootFolders = getGoogleRootFolders();
      for (File folder : googleRootFolders)
      {
         if (folder.getName().equals(driveFolderName))
         {
            return folder.getId();
         }
      }
   ...
   public static String getFolderIdIFExist(String googleFolderIdParent, final String driveFolderName) throws IOException
   {
      List<File> googleRootFolders = getGoogleSubFolders(googleFolderIdParent);
      for (File folder : googleRootFolders)
      {
         if (folder.getName().equals(driveFolderName))
         {
